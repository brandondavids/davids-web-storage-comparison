...
const explanations = {
  1: {
    ...
    wrong:
      "Kurang tepat. LocalStorage lebih cocok karena preferensi theme harus persist dan tidak perlu dikirim ke server setiap request.",
  },
  2: {
    correct:
      "Benar! SessionStorage perfect untuk data form sementara yang harus hilang saat tab ditutup.",
    wrong:
      "Kurang tepat. SessionStorage lebih cocok karena data form wizard sebaiknya hilang jika user menutup tab (privacy & fresh start).",
  },
  3: {
    correct:
      "Benar! Cookies dengan HttpOnly adalah satu-satunya yang bisa melindungi token dari XSS dan dikirim ke server.",
    wrong:
      "Kurang tepat. Hanya Cookies dengan HttpOnly yang bisa melindungi token dari JavaScript (XSS) dan otomatis dikirim ke server.",
  },
  4: {
    correct:
      "Benar! LocalStorage cocok untuk shopping cart yang persist tanpa perlu ke server.",
    wrong:
      "Kurang tepat. LocalStorage lebih cocok karena cart harus persist (tidak hilang jika browser tutup) dan data cart tidak perlu dikirim setiap request.",
  },
};
